...
?>
<?php
//////////// Part 4 - If the customer wants to delete or remove an item/product from the shopping cart
////////////
...
//Dynamic PayPal Checkout Button
$x = $i + 1;
...
//////////////////// The folowing field will be used to display the information in the cart table
		$cartOutput .= '<tr>';
		...
		$cartOutput .= '<td>' .$productDescription. '</td>'; //this will display and let you know the value from the array for product id
		...
		</td>'; //this will remove the unique index ID for the particular item/product in the multy-dimentional array created above
		setlocale(LC_MONETARY, "en");
		$cartTotal = money_format("%10.2n", $cartTotal);
		$cartOutput .= '<tr>';
		//$i++;
		//Close the PayPal checkout button form before submiting its values to Paypal sandbox fr payment.
		...
		<input type="hidden" name="bn" value="PP-BuyNowBF:btn_buynowCC_LG.gif:NonHostedGuest"> <input type="image" src="https://www.sandbox.paypal.com/en_US/GB/i/btn/btn_buynowCC_LG.gif" border="0" name="submit" alt="PayPal — The safer, easier way to pay online."> 
...
<body>
    ...
    <table width="100%" border="1" cellpadding="5" cellspacing="5" style="width:400px; margin-left:490px">
      <tr bgcolor="#FFFFFF">
        <td width="173" align="left" valign="middle"><strong><em>Your Total Price:</em></strong> £ <?php echo $cartTotal; ?></td>
        <td width="146" align="center" valign="middle"><a href="cart.php?cmd=emptycart"><strong>Empty My Shopping Cart</strong></a></td>
      </tr>
    </table><br/>
